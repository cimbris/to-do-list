...
function filterNotes(e){
    ...
    //     console.log(notesList[i].textContent);

    //     let noteLowerCase = notesList[i].textContent.toLowerCase()

    //     if(noteLowerCase.indexOf(searchValue) !== -1){
    //         notesList[i].closest('.list__item').style.display = 'flex'
    //     }
    //     else{
    //         notesList[i].closest('.list__item').style.display = 'none'
    //     }
    // }
